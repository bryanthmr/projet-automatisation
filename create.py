...
def create():
    ...
    file_name = input("Entrez le nom du nouveau fichier CSV : ")
    csv_folder = "csv"
    ...
    while os.path.exists(csv_file_path):  # Vérifie si le fichier existe
...
def modifier():
    ...
    #je les separe avec un ' ' sinon il met 2 fois ','
    for row in data:
        print(' '.join(row))
